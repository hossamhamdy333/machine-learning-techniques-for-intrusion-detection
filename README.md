...
* Building scalable IDS pipelines for extremely large NetFlow datasets
* Comparing tree-based models vs deep learning architectures
* Evaluating robustness under severe class imbalance
* Investigating feature importance and interpretability
* Benchmarking against published research on NF-UQ-NIDS-v2
* Providing reproducible end-to-end notebooks for research and experimentation
